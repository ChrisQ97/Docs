...
basculardos:
	bcf			PORTB, 0
	btfsc		PORTB, 1	;SI PORTB.RB0==0 SALTA LA INSTRUCCION
	goto 		apagar		;salta a apagar en caso de portb ==1
	bsf 		PORTB, 1	;PORTB.RB0 = 1
	bcf			PORTB, 0
	goto 		retardodos		;salta a la etiqueta retardo
	bcf			PORTB, 0
retardodos:
	decfsz		contador,0x25	;contador-- slta al llegar a cero
	goto		retardodos		;vuelve ciclicamente a retardo
	movlw		0xFF		;w= 0xFF
...
retardo:
	...
	movlw		0xFF		;w= 0xFF
	movwf		contador	; contador = w
	goto		basculardos	;salta ciclicamente a bascular
	end 		
